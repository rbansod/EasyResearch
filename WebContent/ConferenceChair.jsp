...
<head>
	...
	<!-- Comments: This is the login page for conference chair -->
	<title>Easy Research-Conference Chair Login</title>
	<link href="css/style.css" rel="stylesheet" type="text/css">
	...
	<div id="main-wraper">
			...
			<table style="width: 100%; display: inline-block;">
				<tbody>
					<tr>
						<td>
							<h2>Easy Research - Conference Chair Login</h2>
						</td>
					</tr>
					<tr>
						<td>
							...
							<form name="form1" action="ConferenceChairLogin" method="post" onsubmit="return chklogin();">	
								<table class="logintable">
									<tbody>
										<tr>
						 				...
						 				<tr>
						 					<td colspan="2" style="font-size: small; text-align:right"><a style="text-decoration: none;" href="ResetPassword.jsp?user=chair">Forgot your password</a></td>
						 				</tr>
						 			</tbody>
						 		</table>
							</form>
